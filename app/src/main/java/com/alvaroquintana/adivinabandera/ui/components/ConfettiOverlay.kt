...
// Flag-appropriate confetti colors: blue, red, white, gold
private val FlagConfettiColors = listOf(
    Color(0xFF1A237E),  // patriotic deep blue
    Color(0xFFC62828),  // rich red
    Color(0xFFFFFFFF),  // white
    Color(0xFFF9CA24),  // gold
    Color(0xFF2ED573),  // green (for tri-color flags)
    ...
    val particles = remember {
        List(particleCount) {
            ConfettiParticle(
                ...
                color = FlagConfettiColors[Random.nextInt(FlagConfettiColors.size)],
